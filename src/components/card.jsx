...
const Card = ({ title, genre, isLocked }) => {
  ...
  // Links de exemplo - substitua pelos links reais
  const musicLinks = {
    "Blinding Lights": {
      spotify: "https://open.spotify.com/track/0VjIjW4GlUZAMYd2vXMi3b",
      youtube: "https://music.youtube.com/watch?v=fHI8X4OXluQ",
    },
    // Adicione links para as outras músicas
  };

  const openService = (service) => {
    window.open(musicLinks[title][service], "_blank");
    setShowDialog(false);
  };
